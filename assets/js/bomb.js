class Bomb {
    ...
    launchBomb() {
        ...
        // avoid the player to walk on a bombed cell
        map.cells[coordCellY][coordCellX].div.classList.add('bombed');
    ...
    destructingBomb() {
        ...
        // avoid the player to walk on a bombed cell
        map.cells[coordCellX][coordCellY].div.classList.remove('bombed');
                        ...
                        if (i == coordCellX) {
                            ...
                            if (!is_unbreakable_i_up) {
                                if (map.cells[i][j].status == 'unbreakable')
                                    ...
                                    map.cells[i][j].div.classList.add('explosion_up_down');
                            }
                        } if ( (i == coordCellX) && (j == coordCellY))
                            map.cells[i][j].div.classList.add('explosion_center');
                    }
                }
            }
        }
