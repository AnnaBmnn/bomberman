        ...
        for (var i = coordCellX - this.powerKill; i <= coordCellX + this.powerKill; i++) { // test on Y
            if (0 < i && i < map.rows) {
                for (var j = 0; j < map.pirates.length; j++) {
                    console.log('map.cells[i][coordCellX].posY ' + map.cells[i][coordCellX].posY+ 'map.pirates[j].playerPosY '+map.pirates[j].playerPosY, ' map.cells[i][coordCellY].posX '+ map.cells[i][coordCellY].posX ,'map.pirates[j].playerPosX' +map.pirates[j].playerPosX)
                    if (map.cells[i][coordCellX].posY === parseInt(map.pirates[j].playerPosY/50) && map.cells[i][coordCellY].posX === parseInt(map.pirates[j].playerPosX/50)) {
                        ...
                        console.log(map.pirates[j].playerLives);
                        return true;
                    }
                }
            }
